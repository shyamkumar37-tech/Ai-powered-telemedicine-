...
- Name: doctor\prescription.spec.js >> Doctor - prescription (Live E2E) >> should execute prescription workflow successfully as Patient
- Location: tests\e2e\specs\doctor\prescription.spec.js:4:3
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e62]:
          - generic [ref=e63]:
            ...
            - textbox "Enter your email" [ref=e65]: patient-1784389619350@example.com
