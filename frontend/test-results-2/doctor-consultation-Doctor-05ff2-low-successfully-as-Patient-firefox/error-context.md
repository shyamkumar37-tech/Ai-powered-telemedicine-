...
- Name: doctor\consultation.spec.js >> Doctor - consultation (Live E2E) >> should execute consultation workflow successfully as Patient
- Location: tests\e2e\specs\doctor\consultation.spec.js:4:3
...
Call log:
  - Expect "toHaveURL" with timeout 15000ms
    16 × unexpected value "http://localhost:5173/login"
  ...
  - main [ref=e6]:
    - generic [ref=e7]:
      ...
      - generic [ref=e46]:
        ...
        - alert [ref=e62]:
          - paragraph [ref=e63]: Backend service is starting. Please wait a moment and try again.
          - button "Retry connection" [ref=e64] [cursor=pointer]
        - alert [ref=e65]: Backend service is starting. Please wait a moment and try again.
        - generic [ref=e66]:
          - generic [ref=e67]:
            - generic [ref=e68]: Email
            - textbox "Enter your email" [ref=e69]: patient-1784389131087@example.com
            - generic [ref=e70]: Use the email you registered with TeleCare+.
          - generic [ref=e71]:
            - generic [ref=e72]: Password
            - textbox "••••••••••" [ref=e73]: Password123!
            - generic [ref=e74]: Use the password created during registration.
        ...
        - generic [ref=e80]:
          ...
          - link "Create an account" [ref=e81] [cursor=pointer]:
            - /url: /register
  - button "Open accessibility tools" [ref=e83] [cursor=pointer]: Accessibility
