...
- Name: doctor\imaging.spec.js >> Doctor - imaging (Live E2E) >> should execute imaging workflow successfully as Patient
- Location: tests\e2e\specs\doctor\imaging.spec.js:4:3
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e65]:
          - generic [ref=e66]:
            ...
            - textbox "Enter your email" [ref=e68]: patient-1784388542922@example.com
