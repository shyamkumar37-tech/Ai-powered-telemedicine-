...
- Name: auth\forgot-password.spec.js >> Auth - forgot-password (Live E2E) >> should execute forgot-password workflow successfully as Patient
- Location: tests\e2e\specs\auth\forgot-password.spec.js:4:3
...
Call log:
  - Expect "toHaveURL" with timeout 15000ms
    15 × unexpected value "http://localhost:5173/login"
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e65]:
          - generic [ref=e66]:
            ...
            - textbox "Enter your email" [ref=e68]: patient-1784388230100@example.com
            - generic [ref=e69]: Use the email you registered with TeleCare+.
          - generic [ref=e70]:
            - generic [ref=e71]: Password
            - textbox "••••••••••" [ref=e72]: Password123!
            - generic [ref=e73]: Use the password created during registration.
        ...
        - generic [ref=e79]:
          - text: New here?
          - link "Create an account" [ref=e80] [cursor=pointer]:
            - /url: /register
  - button "Open accessibility tools" [ref=e82] [cursor=pointer]: Accessibility
