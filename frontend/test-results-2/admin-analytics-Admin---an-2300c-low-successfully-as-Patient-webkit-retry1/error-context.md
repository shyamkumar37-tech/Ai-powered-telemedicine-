...
- Name: admin\analytics.spec.js >> Admin - analytics (Live E2E) >> should execute analytics workflow successfully as Patient
- Location: tests\e2e\specs\admin\analytics.spec.js:4:3
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e62]:
          - generic [ref=e63]:
            ...
            - textbox "Enter your email" [ref=e65]: patient-1784389441514@example.com
