...
- Name: patient\booking.spec.js >> Patient - booking (Live E2E) >> should execute booking workflow successfully as Patient
- Location: tests\e2e\specs\patient\booking.spec.js:4:3
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e62]:
          - generic [ref=e63]:
            ...
            - textbox "Enter your email" [ref=e65]: patient-1784388706521@example.com
