...
- Name: auth\role-based.spec.js >> Auth - role-based (Live E2E) >> should execute role-based workflow successfully as Patient
- Location: tests\e2e\specs\auth\role-based.spec.js:4:3
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e62]:
          - generic [ref=e63]:
            ...
            - textbox "Enter your email" [ref=e65]: patient-1784389516447@example.com
