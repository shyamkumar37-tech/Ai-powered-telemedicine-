...
- Name: auth\role-based.spec.js >> Auth - role-based (Live E2E) >> should handle edge cases and validation in role-based
- Location: tests\e2e\specs\auth\role-based.spec.js:12:3
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e65]:
          - generic [ref=e66]:
            ...
            - textbox "Enter your email" [ref=e68]: doctor-1784388473695@example.com
