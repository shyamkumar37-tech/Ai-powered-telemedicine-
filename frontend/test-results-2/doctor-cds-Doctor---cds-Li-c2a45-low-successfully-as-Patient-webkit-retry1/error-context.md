...
- Name: doctor\cds.spec.js >> Doctor - cds (Live E2E) >> should execute cds workflow successfully as Patient
- Location: tests\e2e\specs\doctor\cds.spec.js:4:3
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e62]:
          - generic [ref=e63]:
            ...
            - textbox "Enter your email" [ref=e65]: patient-1784389595244@example.com
