...
- Name: auth\registration.spec.js >> Auth - registration (Live E2E) >> should execute registration workflow successfully as Patient
- Location: tests\e2e\specs\auth\registration.spec.js:4:3
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e66]:
          - generic [ref=e67]:
            ...
            - textbox "Enter your email" [ref=e69]: patient-1784388420442@example.com
