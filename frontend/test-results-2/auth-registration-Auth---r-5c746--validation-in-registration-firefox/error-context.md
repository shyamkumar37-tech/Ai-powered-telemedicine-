...
- Name: auth\registration.spec.js >> Auth - registration (Live E2E) >> should handle edge cases and validation in registration
- Location: tests\e2e\specs\auth\registration.spec.js:12:3
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e62]:
          - generic [ref=e63]:
            ...
            - textbox "Enter your email" [ref=e65]: doctor-1784389022649@example.com
