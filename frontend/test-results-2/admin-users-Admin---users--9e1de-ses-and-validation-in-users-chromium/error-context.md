...
- Name: admin\users.spec.js >> Admin - users (Live E2E) >> should handle edge cases and validation in users
- Location: tests\e2e\specs\admin\users.spec.js:12:3
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e65]:
          - generic [ref=e66]:
            ...
            - textbox "Enter your email" [ref=e68]: doctor-1784388230632@example.com
