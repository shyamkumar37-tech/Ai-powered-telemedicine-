...
- Name: patient\dashboard.spec.js >> Patient - dashboard (Live E2E) >> should execute dashboard workflow successfully as Patient
- Location: tests\e2e\specs\patient\dashboard.spec.js:4:3
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e62]:
          - generic [ref=e63]:
            ...
            - textbox "Enter your email" [ref=e65]: patient-1784388822975@example.com
