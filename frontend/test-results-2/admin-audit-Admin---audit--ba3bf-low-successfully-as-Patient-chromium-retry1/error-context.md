...
- Name: admin\audit.spec.js >> Admin - audit (Live E2E) >> should execute audit workflow successfully as Patient
- Location: tests\e2e\specs\admin\audit.spec.js:4:3
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e65]:
          - generic [ref=e66]:
            ...
            - textbox "Enter your email" [ref=e68]: patient-1784388283839@example.com
