...
- Name: auth\login.spec.js >> Auth - Live Login Flow >> should show error for invalid credentials using live backend
- Location: tests\e2e\specs\auth\login.spec.js:17:3
...
Locator: locator('.error-message, [role="alert"]')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('.error-message, [role="alert"]')
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e62]:
          - generic [ref=e63]:
            ...
            - textbox "Enter your email" [ref=e65]: wrong-user-live@example.com
            - generic [ref=e66]: Use the email you registered with TeleCare+.
          - generic [ref=e67]:
            - generic [ref=e68]: Password
            - textbox "••••••••••" [ref=e69]: badpass123!
