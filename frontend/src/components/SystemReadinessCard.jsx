...
function summarizeAvailability(value, text) {
...
function translateWarning(language, warning, translateUiText) {
...
export default function SystemReadinessCard({ compact = false }) {
