...
import { Bluetooth, BluetoothConnected, BluetoothSearching, Radio, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="bg-tcd-panel-2 border-t border-tcd-panel-line p-4">
      <div className="flex items-center justify-between mb-3">
        <h4 className="text-sm font-semibold text-tcd-text-primary flex items-center gap-2">
          <Radio className="w-4 h-4 text-tcd-teal" />
          IoT Tele-Exam Devices
        </h4>
        <div className="text-xs text-tcd-text-muted">
          Support for Bluetooth stethoscopes & otoscopes
        </div>
      </div>
