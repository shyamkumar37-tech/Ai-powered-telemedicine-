      ...
      >
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {filteredGaps.map((gap, index) => (
            <div key={`${gap.patientId}-${gap.gapType}-${index}`} className="rounded-xl border border-white/10 bg-white/5 p-5 transition-colors hover:bg-white/10 flex flex-col h-full">
              ...
              <div className="mt-auto bg-black/20 p-3 rounded-lg border border-white/5 flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs font-medium text-slate-400 uppercase tracking-wider mb-1">Recommended Action</p>
