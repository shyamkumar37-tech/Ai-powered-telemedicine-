  ...
  return (
    <PageContainer className="px-4 py-16 md:px-8">
      <div className="glass-card mx-auto max-w-3xl p-8">
        ...
        <h1 className="mt-3 text-3xl font-semibold text-ink">{translateUiText("Terms")}</h1>
        <p className="mt-4 text-sm text-slate-600">
          {translateUiText("TeleCare+ is an academic project. Clinical advice should always be verified with a licensed professional.")}
        </p>
        <p className="mt-3 text-sm text-slate-600">
          {translateUiText("This page will include full terms and conditions for official deployments.")}
        </p>
