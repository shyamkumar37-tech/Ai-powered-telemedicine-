...
export default function PrescriptionPrintPage() {
  ...
  const [prescription, setPrescription] = useState<DynamicStateObject | null>(null);
  ...
  useEffect(() => {
    ...
    (fetchPrescription(prescriptionId as string) as any)
      ...
      .catch((err: DynamicStateObject) => setError(getApiErrorMessage(err, t("unableLoadPrintablePrescription"))))
